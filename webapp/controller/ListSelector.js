sap.ui.define([
	...
	return BaseObject.extend("App_CRUD.AplicacaoCRUD.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias App_CRUD.AplicacaoCRUD.model.ListSelector
		 */
		 ...
		 * @return {App_CRUD.AplicacaoCRUD.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
