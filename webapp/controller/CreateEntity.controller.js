sap.ui.define([
	...
	return BaseController.extend("App_CRUD.AplicacaoCRUD.controller.CreateEntity", {
		...
		_onCreate: function (oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Zcdscrud_abap07", {
		...
		_fnEntityCreated: function (oData) {
			var sObjectPath = this.getModel().createKey("Zcdscrud_abap07", oData);
