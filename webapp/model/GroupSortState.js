sap.ui.define([
	...
	return BaseObject.extend("App_CRUD.AplicacaoCRUD.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias App_CRUD.AplicacaoCRUD.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "dats");
			}
