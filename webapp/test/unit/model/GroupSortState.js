sap.ui.define([
	"App_CRUD/AplicacaoCRUD/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("dats").length, 1, "The sorting by dats returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by dats and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("dats");
