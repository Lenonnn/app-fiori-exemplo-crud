sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("App_CRUD/AplicacaoCRUD/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#AplicacaoCRUD-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#AplicacaoCRUD-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("App_CRUD.AplicacaoCRUD.test.integration.pages.Common", {
		...
		getMockServer: function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["App_CRUD/AplicacaoCRUD/localService/mockserver"], function (mockserver) {
